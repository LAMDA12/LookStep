#!/usr/bin/env bash
# LookStep RxR-CE simulator evaluation entry point.
set -euo pipefail
...
CONFIG_PATH=${CONFIG_PATH:-${LOOKSTEP_ROOT}/simulation/configs/rxr.yaml}
DATA_ROOT=${DATA_ROOT:-${LOOKSTEP_DATA_ROOT:-${PROJECT_PARENT}/data}}
EVAL_SPLIT=${EVAL_SPLIT:-val_unseen}
OUTPUT_PATH=${OUTPUT_PATH:-${LOOKSTEP_ROOT}/simulation/outputs/rxr_${EVAL_SPLIT}}
